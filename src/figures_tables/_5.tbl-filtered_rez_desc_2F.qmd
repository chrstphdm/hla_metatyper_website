...
\blandscape
```{python}
#| label: tbl-filtered_rez_desc_2F
#| tbl-cap: Description of the impact of filters on the number of matching calls (**results DOWNSCALED to 2 fields**) in 2 and 3 algorithms + hemizygous. The percentage of concordant calls is calculated in relation to the total number of samples in this study (14,669).
import pandas
import numpy as np
...
def tbl_filtered_rez_desc_2F():
  rez = pandas.read_csv('data/OUTPUT/5.N_1_RESULTS/all_results-2F-filtered.csv')
  rez2 = pandas.read_csv('data/OUTPUT/5.N_1_RESULTS/all_results-2F.csv')
