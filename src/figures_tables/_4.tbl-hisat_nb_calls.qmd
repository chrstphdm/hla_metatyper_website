...
```{python}
#| label: tbl-hisat_nb_calls
#| tbl-cap: This table describe the number of calls obtained from HISATgenotype regarding the quality of alleles only. Considering the average size of an exon (150bp) and an intron (1 - 50KB) in the human genome, we will use the value of 200 reads as a threshold. 
#| 
import pandas
import numpy as np
...
def tbl_hisat_nb_calls():
  rez_filtered_hisat = pandas.read_csv('data/OUTPUT/5.N_1_RESULTS/all_results-filtered.csv')
