...
```{python}
#| label: fig-hisat_genotypes_barplot
#| fig-cap: Proportion of Heterozygous (Htz), Homozygous (Hmz) and untyped samples for each typers (after applying quality filters). Vertical green line match with the 14,366 samples.
#| fig-subcap: 
#|   - "HISAT-genotype"
#|   - "HLA-HD"
#|   - "T1K"
