...
```{python}
#| label: tbl-heterozygosity_cmp
#| tbl-cap: Comparison of homozigosity percentage for each typer. Genes DRB[2345] have been ignored, as well as the genes that have not been typed by the 3 algorithms.
#| 
import pandas
import numpy as np
